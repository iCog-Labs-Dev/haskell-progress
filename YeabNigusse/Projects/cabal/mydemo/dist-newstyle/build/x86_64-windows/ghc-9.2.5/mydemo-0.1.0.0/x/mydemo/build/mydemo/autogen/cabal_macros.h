...
/* package mydemo-0.1.0.0 */
#ifndef VERSION_mydemo
#define VERSION_mydemo "0.1.0.0"
#endif /* VERSION_mydemo */
#ifndef MIN_VERSION_mydemo
#define MIN_VERSION_mydemo(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_mydemo */
...
#define CURRENT_COMPONENT_ID "mydemo-0.1.0.0-inplace-mydemo"
