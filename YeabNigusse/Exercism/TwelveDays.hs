...
recite start stop = mySong [start .. stop] twelveDays

type Day = Int
type Message = String

twelveDays :: [(Day, Message)]
twelveDays =
...
mySong :: [Int] -> [(Int, String)] -> [String]
mySong [] _ = []
mySong (x:xs) twelveDays =  findKey x twelveDays : mySong xs twelveDays
