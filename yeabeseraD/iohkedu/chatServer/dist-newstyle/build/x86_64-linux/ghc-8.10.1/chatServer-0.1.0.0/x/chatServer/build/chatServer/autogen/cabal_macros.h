...
/* package chatServer-0.1.0.0 */
#ifndef VERSION_chatServer
#define VERSION_chatServer "0.1.0.0"
#endif /* VERSION_chatServer */
#ifndef MIN_VERSION_chatServer
#define MIN_VERSION_chatServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_chatServer */
/* package async-2.2.4 */
...
#define CURRENT_COMPONENT_ID "chatServer-0.1.0.0-inplace-chatServer"
