...
/* package networkServer-0.1.0.0 */
#ifndef VERSION_networkServer
#define VERSION_networkServer "0.1.0.0"
#endif /* VERSION_networkServer */
#ifndef MIN_VERSION_networkServer
#define MIN_VERSION_networkServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_networkServer */
...
#define CURRENT_COMPONENT_ID "networkServer-0.1.0.0-inplace-networkClient"
