...
/* package weather-0.1.0.0 */
#ifndef VERSION_weather
#define VERSION_weather "0.1.0.0"
#endif /* VERSION_weather */
#ifndef MIN_VERSION_weather
#define MIN_VERSION_weather(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_weather */
...
#define CURRENT_COMPONENT_ID "weather-0.1.0.0-inplace-weather"
